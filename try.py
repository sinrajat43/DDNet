  ...
  #              (190, 90),  
   #             font, 1,  
                ...
                if(t2==1):
                    if(t3==1):
                        ...
                        if((x.hour<6 and x.hour>2) or (x.hour<18 and x.hour>15)):
                            if(c3<40  and s>52 and fcount4<=100 and ((alarm==0 and label[int(i)]=="Sleeping") or c3!=0)):
                            ...
                            if(s>65  and c3<40 and fcount4<=150 and ((alarm==0 and label[int(i)]=="Sleeping") or c3!=0)):
                                fcount4=fcount4-1
                                c3=c3+1
                                #
                                alarm=1
                        ...
                        if(b>=58  and c4<40 and fcount5<=130 and ((alarm==0 and label[int(i)]=="Watching Backward") or c4!=0)):
    ...
    #                           
                        ...
                        if((x.hour<6 and x.hour>2) or (x.hour<18 and x.hour>15)):
                            if(c3<40  and s>70 and fcount4<=100 and ((alarm==0 and label[int(i)]=="Sleeping") or c3!=0)):
                                cv2.putText(samp,"Sleep -- Focus on Driving",(20, 100),font, 1.4,(255, 255, 255),3,cv2.LINE_4)
                                #
                                #
                            ...
                            if(s>80  and c3<40 and fcount4<=150 and ((alarm==0 and label[int(i)]=="Sleeping") or c3!=0)):
                                fcount4=fcount4-1
                                c3=c3+1
                                alarm=1
                                #
                        ...
                        if(b>=75  and c4<40 and fcount5<=130 and ((alarm==0 and label[int(i)]=="Watching Backward") or c4!=0)):
                            fcount5=fcount5-1
                            c4=c4+1
                            alarm=1
                            #
    ...
    #                           
                ...
                if(t2==4):
                  #Talking_via_phone fcount1,j,k,c
                    ...
                    if(b>=95  and c4<40 and fcount5<=130 and ((alarm==0 and label[int(i)]=="Watching Backward") or c4!=0)):
    ...
    #                           
                        ...
                        if((x.hour<6 and x.hour>2) or (x.hour<18 and x.hour>15)):
                            if(c3<40  and s>60 and fcount4<=100 and ((alarm==0 and label[int(i)]=="Sleeping") or c3!=0)):
                                cv2.putText(samp,"Sleep -- Focus on Driving",(20, 100),font, 1.4,(255, 255, 255),3,cv2.LINE_4)
                                #
                                #
                        ...
                        if(b>=70  and c4<40 and fcount5<=130 and ((alarm==0 and label[int(i)]=="Watching Backward") or c4!=0)):
                            fcount5=fcount5-1
                            c4=c4+1
                            alarm=1
                            #
    ...
    #                           
                        ...
                        if((x.hour<6 and x.hour>2) or (x.hour<18 and x.hour>15)):
                            if(c3<40  and s>77 and fcount4<=100 and ((alarm==0 and label[int(i)]=="Sleeping") or c3!=0)):
                                cv2.putText(samp,"Sleep -- Focus on Driving",(20, 100),font, 1.4,(255, 255, 255),3,cv2.LINE_4)
                                #
                                #
                                cv2.putText(samp, "Response Time : "+str(round(((sleep6)/790)*30, 2))+"s", (20, 140), font, 1, (255, 255, 255), 3, cv2.LINE_4)
                            ...
                            if(s>90  and c3<40 and fcount4<=150 and ((alarm==0 and label[int(i)]=="Sleeping") or c3!=0)):
                                fcount4=fcount4-1
                                c3=c3+1
                                alarm=1
                                #
                        ...
                        if(b>=83  and c4<40 and fcount5<=130 and ((alarm==0 and label[int(i)]=="Watching Backward") or c4!=0)):
                            fcount5=fcount5-1
                            c4=c4+1
                            alarm=1
                            #
    ...
    #                           
                        ...
                        if((x.hour<6 and x.hour>2) or (x.hour<18 and x.hour>15)):
                            if(c3<40  and s>76 and fcount4<=100 and ((alarm==0 and label[int(i)]=="Sleeping") or c3!=0)):
                                cv2.putText(samp,"Sleep -- Focus on Driving",(20, 100),font, 1.4,(255, 255, 255),3,cv2.LINE_4)
                                #
                                #
    ...
    #                           
                        ...
                        if(b>=84 and c4<40 and fcount5<=130 and ((alarm==0 and label[int(i)]=="Watching Backward") or c4!=0)):
                            fcount5=fcount5-1
                            c4=c4+1
                            alarm=1
                            #
                ...
                if(t2==4):    
                  ...
                  #  cv2.putText(samp,"  "+str(j),(20, 190),font, 1.4,(255, 255, 255),3,cv2.LINE_4)
                    ...
                    if((x.hour<6 and x.hour>2) or (x.hour<18 and x.hour>15)):
                        if(c3<40  and s>97 and fcount4<=100 and ((alarm==0 and label[int(i)]=="Sleeping") or c3!=0)):
                            cv2.putText(samp,"Sleep -- Focus on Driving",(20, 100),font, 1.4,(255, 255, 255),3,cv2.LINE_4)
                            #
                            #
                        ...
                        if(s>110  and c3<40 and fcount4<=150 and ((alarm==0 and label[int(i)]=="Sleeping") or c3!=0)):
                            fcount4=fcount4-1
                            c3=c3+1
                            alarm=1
                            #
                    ...
                    if(b>=103  and c4<40 and fcount5<=130 and ((alarm==0 and label[int(i)]=="Watching Backward") or c4!=0)):
